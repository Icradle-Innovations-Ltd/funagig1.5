...
3. Import the database schema:
   ...
   - Go to "Import" tab
   - Choose file: `database/database_unified.sql`
   - Click "Go" to import
...
├── database/
│   └── database_unified.sql    # Database schema
...
├── business-gigs.html          # Business gig management
...
### Sample Data
The database includes sample users and gigs for testing:
- **Students**: john@example.com, alex@example.com
- **Businesses**: sarah@example.com, info@techsolutions.com
