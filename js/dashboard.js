...
class DashboardManager {
    ...
    updateBusinessStats() {
        ...
        // Update stat cards with correct property names
        ...
        this.updateStatCard('avg-rating', stats.average_rating || 0);
        this.updateStatCard('completed-projects', stats.completed_projects || 0);
        this.updateStatCard('total-revenue', stats.total_revenue || 0);
    }
