...
```
php/
├── api.php          # Main API router (endpoints for gigs, applicants, messages, etc.)
└── config.php       # DB connection (mysqli) and utilities

database/
└── database_unified.sql  # Schema (users, gigs, applications, messages)
```
...
### Database Changes
1. Update schema in `database_unified.sql`
