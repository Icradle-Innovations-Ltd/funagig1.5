...
This document contains all the demo accounts created for testing the FunaGig platform.
...
### **Student Testing:**
1. **Login as Alice** (alice@demo.com) - Computer Science student
